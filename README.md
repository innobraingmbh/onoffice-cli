...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/onoffice-cli.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/onoffice-cli)
...
```bash
php artisan vendor:publish --tag="onoffice-cli-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="onoffice-cli-views"
```

## Usage

```php
$onofficeCli = new InnoBrain\OnofficeCli();
echo $onofficeCli->echoPhrase('Hello, InnoBrain!');
```
